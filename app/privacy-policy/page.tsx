    ...
    <main className="min-h-screen bg-[#03111f] px-6 py-12 text-white">
      <div className="mx-auto max-w-5xl rounded-[28px] border border-emerald-400/20 bg-[#07192f]/90 p-8 shadow-[0_0_60px_rgba(0,255,120,0.08)]">
        ...
        <div className="mt-8 space-y-6 text-slate-300 leading-8">
          <p>HELOC CONNECT respects your privacy. This Privacy Policy explains how we collect, use, and protect information submitted through our website forms.</p>
          <section><h2 className="text-2xl font-black text-white">Information We Collect</h2><p>We may collect information you voluntarily provide, including your name, phone number, email address, property details, inquiry details, and related contact information.</p></section>
